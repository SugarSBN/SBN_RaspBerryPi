...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/ffmpeg --enable-shared --enable-pthreads --enable-gpl --enable-avresample --enable-libx264 --disable-yasm
prefix=/opt/ffmpeg
...
LIBFUZZER_PATH=
IGNORE_TESTS=
avdevice_FFLIBS=avfilter swscale postproc avformat avcodec swresample avresample avutil
avfilter_FFLIBS=swscale postproc avformat avcodec swresample avresample avutil
...
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -lx264
